  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-[#00D1FF] selection:text-black">
      ...
      <footer className="absolute bottom-10 w-full text-center px-6">
        <div className="max-w-4xl mx-auto border-t border-white/5 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            ...
            <Link href="/admin" className="text-[10px] text-gray-600 hover:text-[#00D1FF] uppercase font-bold tracking-widest transition">Admin Command</Link>
          </div>
        </div>
      </footer>
    </main>
